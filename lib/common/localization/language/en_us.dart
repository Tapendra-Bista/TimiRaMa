...
final Map<String, String> enUS = {
  EnumLocale.appName.name: 'TimiRaMa',
...
You are always in control of your data. You can update or delete your profile, disable location sharing, and even request account deletion at any time. TimiRaMa uses secure technologies to protect your information, including encryption and regular security checks, but we also encourage users to take personal precautions such as safeguarding login credentials.

TimiRaMa is intended strictly for individuals aged 18 or older. We do not knowingly collect or process data from minors. By using our app, you agree to this privacy policy and any future updates we may apply. If changes are made to how we handle your data, we’ll notify you through the app or email.

If you have any questions or concerns about how we use your information, you can contact us at privacy@TimiRaMa.app.""",
  EnumLocale.conditionOfUseTitle.name:
      "TimiRaMa – Terms and Conditions of Use\n",
  EnumLocale.conditionOfUseBody.name: """
By using TimiRaMa, you agree to the following terms and conditions. These terms govern your access to and use of the TimiRaMa app and services. Please read them carefully.

1. Eligibility: TimiRaMa is only available to users who are 18 years of age or older. By using the app, you confirm that you meet this age requirement and are legally able to enter into a binding agreement.
...
4. Content and Usage Rights: While you retain ownership of the content (photos, bio, messages, etc.) you upload, you grant TimiRaMa a worldwide, non-exclusive, royalty-free license to use and display your content within the app for the purpose of delivering its matchmaking services.

5. Paid Features: Some features in TimiRaMa are available through paid subscriptions. Payments are processed via the respective app store (Google Play or App Store). Subscriptions may automatically renew unless cancelled before the end of the billing period. Refunds follow the platform’s policy.

6. Prohibited Behavior: You must not use TimiRaMa for illegal or harmful activities. This includes spamming, distributing malware, stalking, soliciting money, or using bots or scripts to manipulate features. Any violation of these rules may lead to immediate termination of your account.

7. Termination: TimiRaMa reserves the right to suspend or terminate any account at any time for violation of these terms or for any conduct that may harm the community or the app’s reputation.
...
12. Contact Information: If you have questions about these terms, please contact us at support@TimiRaMa.app.""",
  ...
  EnumLocale.welcomeDescriptionText.name:
      """Welcome to TimiRaMa! Ready to meet some great people? Tell us a bit about yourself and what you're looking for. Keep it real, share a smile in your pic, and start exploring. Your next connection could be just a swipe away!""",
...
EnumLocale.photography.name: "Photography",
EnumLocale.reading.name: "Reading",
EnumLocale.writing.name: "Writing",
EnumLocale.technology.name: "Technology",
EnumLocale.dance.name: "Dance",
...
EnumLocale.groupActivities.name: "Group Activities",
EnumLocale.picnicPartner.name: "Picnic Partner",
EnumLocale.bookClub.name: "Book Club",
EnumLocale.boardGames.name: "Board Games",
EnumLocale.volunteering.name: "Volunteering",
...
EnumLocale.longWalks.name: "Long Walks",
EnumLocale.holdingHands.name: "Holding Hands",
EnumLocale.poetry.name: "Poetry",
EnumLocale.surpriseGifts.name: "Surprise Gifts",
EnumLocale.stargazing.name: "Stargazing",
...
EnumLocale.swimming.name: "Swimming",
EnumLocale.trekking.name: "Trekking",
EnumLocale.skating.name: "Skating",
EnumLocale.rockClimbing.name: "Rock Climbing",
EnumLocale.natureWalks.name: "Nature Walks",
...
EnumLocale.homeCooking.name: "Home Cooking",
EnumLocale.veganCuisine.name: "Vegan Cuisine",
EnumLocale.dessertLover.name: "Dessert Lover",
EnumLocale.cookingTogether.name: "Cooking Together",
EnumLocale.restaurantHopper.name: "Restaurant Hopper",
...
EnumLocale.jungleSafari.name: "Jungle Safari",
EnumLocale.scubaDiving.name: "Scuba Diving",
EnumLocale.mountainBiking.name: "Mountain Biking",
EnumLocale.culturalTours.name: "Cultural Tours",
EnumLocale.beachHolidays.name: "Beach Holidays",
