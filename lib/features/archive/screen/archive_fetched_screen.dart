...
import 'package:timirama/features/archive/widgets/archive_fetched_screen_widgets.dart';
      ...
      builder: (context, favData) {
        return PlatformScaffold(
          appBar: PlatformAppBar(
            ...
            title: Text(EnumLocale.archive.name.tr, style: theme.bodyMedium),
          ),
          body: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return RepaintBoundary(
                child: Container(
                  key: ValueKey(item.id), // Add unique key for better performance
