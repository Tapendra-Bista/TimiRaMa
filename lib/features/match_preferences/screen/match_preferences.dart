...
class MatchPreferencesScreen extends StatelessWidget {
  MatchPreferencesScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    final _match_preferencesBloc = context.read<MatchPreferencesBloc>();
    ...
    return PlatformScaffold(
      ...
      body: BlocBuilder<MatchPreferencesBloc, MatchPreferencesState>(
  ...
  /// Custom button builder for match_preferences
